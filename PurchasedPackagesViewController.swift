...
class PurchasedPackagesViewController: UIViewController, PurchasePackageButtonCellDelegate, UITableViewDelegate, UITableViewDataSource, UIPopoverPresentationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.callMsgLabel.text = "Please click on ‘Chat’ (or ‘My Chat’), and send a message, requesting for a call, to your assigned nutritionist.Your assigned Nutritionist will call you ASAP"
