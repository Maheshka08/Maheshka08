...
extension SyncManager {
    ...
    @objc public static var shared: SyncManager {
        return __shared()
    }
}
...
extension SyncUser {
    ...
    @objc public static var all: [String: SyncUser] {
        return __allUsers()
    }
     ...
     */
    @objc public static var current: SyncUser? {
        return __current()
    }
...
extension SyncPermissionResults: RandomAccessCollection {
    @objc public subscript(index: Int) -> SyncPermissionValue {
        return object(at: index)
    }

    @objc public func index(after i: Int) -> Int {
        return i + 1
    }
...
public final class SyncPermissionChange: Object {
    ...
    @objc public var status: SyncManagementObjectStatus {
...
public final class SyncPermissionOffer: Object {
     ...
     */
    @objc public convenience init(realmURL: String, expiresAt: Date?, mayRead: Bool, mayWrite: Bool, mayManage: Bool) {
        self.init()
        self.realmUrl = realmURL
...
public final class SyncPermissionOfferResponse: Object {
    ...
    /**
     ...
     - parameter token: The received token which uniquely identifies another user's
                        `SyncPermissionOffer`.
     */
    @objc public convenience init(token: String) {
        self.init()
        self.token = token
    }
